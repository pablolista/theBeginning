...
fs.readFile("funcionarios.json", "utf-8", function(err, data){
    if (err){
        ...
        console.log("O menor salario da Administração é " + maiorSalario("Administrativo"));
        console.log("O menor salario da Produção é " + maiorSalario("Produção"));
        console.log("O menor salario do Comercial é " + maiorSalario("Comercial"));
